...
const blogPosts: BlogDirectoryPost[] = [
  ...
  },
  {
    ...
    summary: "A rigorous treatment of fourteen philosophical questions about artificial general intelligence, organised around the five kinds of fact that could make their answers true.",
    title: "What Makes It True? — fourteen philosophical questions about artificial general intelligence"
  },
  {
    path: "blog-articles/ai/agi/what-is-supposed-to-stay-the-same.html",
    publishedAt: "2026-08-24",
    summary: "The sixteen major unsolved technical problems in artificial general intelligence, restated as invariance claims: a quantity, a class of perturbations, and five reasons the constancy fails.",
    title: "What Is Supposed to Stay the Same? · Unsolved technical problems on the path to AGI"
  },
  {
    path: "blog-articles/ai/agi/what-changes-and-how-fast.html",
    publishedAt: "2026-08-24",
    summary: "Architectures for artificial general intelligence, read as decisions about which store carries which content.",
    title: "What Changes, and How Fast? — architectures for artificial general intelligence"
  },
  {
    path: "blog-articles/ai/agi/over-what-does-it-have-to-hold.html",
    publishedAt: "2026-08-24",
    summary: "Cognitive capabilities for artificial general intelligence, and the ranges that give them content.",
    title: "Over What Does It Have to Hold?"
  },
  {
    path: "blog-articles/hpc/how-much-has-to-be-in-flight.html",
    publishedAt: "2026-08-24",
    summary: "A rigorous treatment of HPC computer architecture organised around one question: how many transfers must be outstanding for each level of the machine to run at its rated speed.",
    title: "How Much Has to Be in Flight? — computer architecture for high-performance computing"
  },
  {
    path: "blog-articles/hpc/hpc-applications.html",
    publishedAt: "2026-08-24",
    summary: "A resource-limited reading of thirteen application areas of high-performance computing, with a deterministic laboratory of eight experiments and Vancouver references.",
    title: "Which Resource Runs Out First? Thirteen Applications of High-Performance Computing"
  },
  {
    path: "blog-articles/hpc/hpc-operations.html",
    publishedAt: "2026-08-24",
    summary: "High-performance computing operations, read as a stack of feedback loops — and a lab that measures what happens when a loop is slower than the thing it controls.",
    title: "The Time Constants of a Supercomputer — high-performance computing operations"
  },
  {
    path: "blog-articles/engineering/knowledge-graphs-and-metaphysics.html",
    publishedAt: "2026-08-24",
    summary: "Knowledge graphs are one place where metaphysical and ontological assumptions become computationally concrete, and GraphRAG is one way of exploiting that structured ontology for machine reasoning.",
    title: "What Survives Encoding? Knowledge graphs, ontological commitment, and the GraphRAG reasoning layer"
  },
  {
    path: "blog-articles/ai/agi/general-over-what.html",
    publishedAt: "2026-08-24",
    summary: "A technical account of what general means in artificial general intelligence: thirty-five capacities placed on a seven-rung ladder of quantifier scope, with deterministic experiments and Vancouver references.",
    title: "General Over What? — the scope of the quantifier in artificial general intelligence"
  },
  {
  ...
  {
    path: "blog-articles/spring/spring-asynchronous-programming.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to asynchronous programming in Spring, including @Async, TaskExecutor, CompletableFuture, thread pools, context propagation, transactions, testing, and operations.",
    title: "Asynchronous Programming in Spring: @Async, TaskExecutor, CompletableFuture, and Thread Pools"
  },
  {
    path: "blog-articles/spring/spring-bean-validation.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to Bean Validation in Spring, including Jakarta Validation, custom constraints, validation groups, constraint validators, MVC, WebFlux, method validation, localization, and testing.",
    title: "Bean Validation in Spring: Jakarta Validation, Custom Constraints, Groups, and Constraint Validators"
  },
  {
    path: "blog-articles/spring/spring-best-practices.html",
    publishedAt: "2026-07-31",
    summary: "An expert field guide to Spring best practice, current through Spring Framework 7.0 and Spring Boot 4.1: constructor injection, architecture, exception handling, validation, configuration, security, logging, testing, performance, observability, API versioning and dependency management.",
    title: "The Twelve Disciplines of Production Spring"
  },
  {
    path: "blog-articles/spring/spring-cloud.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to Spring Cloud, including Config Server, distributed configuration, service discovery, Gateway, OpenFeign, LoadBalancer, CircuitBreaker, Bus, Stream, testing, security, and operations.",
    title: "Spring Cloud: Configuration, Discovery, Gateway, Clients, Resilience, Bus, and Stream"
  },
  {
    path: "blog-articles/spring/spring-core-annotations.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to core Spring annotations including component stereotypes, Java configuration, dependency injection, qualifiers, profiles, scopes, lazy initialization, and initialization ordering.",
    title: "Core Annotations in Spring: Components, Configuration, Injection, Profiles, Scopes, and Lifecycle"
  },
  {
    path: "blog-articles/spring/spring-data-jpa.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level guide to Spring Data JPA repositories, CrudRepository, JpaRepository, PagingAndSortingRepository, derived queries, JPQL, native SQL, Specifications, Querydsl, Pageable, Sort, Slice, and Page.",
    title: "Spring Data JPA: Repositories, Query Methods, Specifications, Querydsl, and Pagination"
  },
  {
    path: "blog-articles/spring/spring-data-modules.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level guide to Spring Data modules for MongoDB, Redis, Cassandra, Elasticsearch, Neo4j, JDBC, and R2DBC.",
    title: "Spring Data Modules: MongoDB, Redis, Cassandra, Elasticsearch, Neo4j, JDBC, and R2DBC"
  },
  {
    path: "blog-articles/spring/spring-deployment.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to Spring deployment, including embedded Tomcat and Jetty, Undertow compatibility, WAR deployment, executable JARs, Docker images, and Kubernetes.",
    title: "Spring Deployment: Embedded Servers, WARs, Executable JARs, Docker, and Kubernetes"
  },
  {
    path: "blog-articles/spring/spring-environment-and-profiles.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level guide to Spring Environment and Profiles, property sources, properties files, YAML configuration, active profiles, externalized configuration, typed binding, and testing.",
    title: "Spring Environment and Profiles: Property Sources, YAML, Active Profiles, and Externalized Configuration"
  },
  {
    path: "blog-articles/spring/spring-file-uploads.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to file uploads in Spring, including multipart requests, MultipartFile, secure file storage, metadata, validation, downloads, range requests, and error handling.",
    title: "File Uploads in Spring: Multipart Requests, Secure Storage, and Downloads"
  },
  {
    path: "blog-articles/spring/spring-integration-patterns.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level survey of integration patterns across the Spring portfolio in 2026: REST and HTTP interface clients, contract-first SOAP, GraphQL batch loading, gRPC in Spring Boot 4.1, messaging with Spring Integration and Kafka, the transactional outbox, and Spring Batch 6 scaling.",
    title: "Integration Patterns in the Spring Ecosystem: REST, SOAP, GraphQL, gRPC, Messaging and Batch"
  },
  {
    path: "blog-articles/spring/spring-internationalization.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to internationalization and localization in Spring, including MessageSource, LocaleResolver, message bundles, formatting, validation, MVC, WebFlux, testing, and production practices.",
    title: "Internationalization in Spring: MessageSource, Locale Resolution, Localization, and Formatting"
  },
  {
    path: "blog-articles/spring/spring-jdbc.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level technical guide to JDBC with Spring, covering JdbcTemplate, NamedParameterJdbcTemplate, RowMapper, exception translation, transactions, generated keys, and batch operations.",
    title: "JDBC with Spring: JdbcTemplate, Named Parameters, Row Mapping, Exception Translation, and Batch Operations"
  },
  {
    path: "blog-articles/spring/spring-messaging.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to Spring Messaging, JMS, STOMP over WebSocket, RabbitMQ with Spring AMQP, and Apache Kafka with Spring Kafka.",
    title: "Spring Messaging: JMS, STOMP, WebSockets, RabbitMQ, and Apache Kafka"
  },
  {
    path: "blog-articles/spring/spring-microservices.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to building microservices with Spring, including decomposition, gateways, discovery, configuration, communication, event-driven architecture, sagas, CQRS, and event sourcing.",
    title: "Building Microservices with Spring: Decomposition, Communication, Sagas, CQRS, and Event Sourcing"
  },
  {
    path: "blog-articles/spring/spring-mvc.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level technical treatment of Spring MVC: DispatcherServlet architecture, handler mapping and adaptation, annotated controllers, Bean Validation, exception handling and view technologies, with Vancouver-cited sources.",
    title: "Spring MVC - Architecture, controllers, validation, exception handling and view technologies in the Spring Framework 7 generation"
  },
  {
    path: "blog-articles/spring/spring-native-graalvm.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to Spring Native, Spring AOT, GraalVM Native Image, reflection and reachability hints, native builds, testing, and performance trade-offs.",
    title: "Spring Native and GraalVM: AOT Compilation, Native Images, Runtime Hints, and Performance"
  },
  {
    path: "blog-articles/spring/spring-observability.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to observability in Spring, including SLF4J, Logback, Log4j2, structured logging, Micrometer, Prometheus, Grafana, distributed tracing, and OpenTelemetry.",
    title: "Observability in Spring: Logging, Metrics, Prometheus, Grafana, Tracing, and OpenTelemetry"
  },
  {
    path: "blog-articles/spring/spring-orm-integration.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to ORM integration with Spring, including JPA, Hibernate, EclipseLink, EntityManager, transactions, exception translation, and Spring Data JPA repositories.",
    title: "ORM Integration with Spring: JPA, Hibernate, EclipseLink, EntityManager, and Repositories"
  },
  {
    path: "blog-articles/spring/spring-performance-optimization.html",
    publishedAt: "2026-07-31",
    summary: "An expert guide to performance optimization in Spring, including bean optimization, lazy initialization, connection pooling, caching, JVM tuning, profiling, and memory optimization.",
    title: "Performance Optimization in Spring: Beans, Connections, Caching, JVM Tuning, Profiling, and Memory"
  },
  {
    path: "blog-articles/spring/spring-resource-management.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level technical guide to Spring resource management, including Resource, ResourceLoader, ClassPathResource, FileSystemResource, UrlResource, pattern resolution, injection, custom protocols, testing, and secure resource access.",
    title: "Spring Resource Management: Resource Abstraction, Loaders, Classpath, Filesystem, and URL Resources"
  },
  {
    path: "blog-articles/spring/spring-rest-apis.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level technical guide to REST APIs in Spring, covering REST constraints, HTTP methods, status codes, content negotiation, JSON, XML, HATEOAS, ResponseEntity, headers, response bodies, caching, errors, and testing.",
    title: "REST APIs in Spring: HTTP Semantics, Content Negotiation, HATEOAS, Headers, and Response Bodies"
  },
  {
    path: "blog-articles/spring/spring-scheduling.html",
    publishedAt: "2026-07-31",
    summary: "Expert guide to Spring scheduling, @Scheduled, cron expressions, fixed delay, fixed rate, scheduler configuration, reactive tasks, distributed coordination, testing, and operations.",
    title: "Spring Scheduling: @Scheduled, Cron, Fixed Delay, and Fixed Rate"
  },
  {
    path: "blog-articles/spring/spring-transactions.html",
    publishedAt: "2026-07-31",
    summary: "An expert-level technical guide to transactions in Spring, including ACID, declarative and programmatic transactions, @Transactional, propagation, isolation, rollback behavior, reactive transactions, and testing.",
...
const blogPostCategoriesByPath: Record<string, BlogCategory[]> = {
  ...
  "blog-articles/ai/agi/over-what-does-it-have-to-hold.html": ["AGI", "Machine Learning", "Philosophy", "AI Strategy"],
  "blog-articles/hpc/how-much-has-to-be-in-flight.html": ["High-Performance Computing", "Hardware", "Engineering", "Operating Systems"],
  "blog-articles/hpc/hpc-applications.html": ["High-Performance Computing", "Engineering"],
  "blog-articles/hpc/hpc-operations.html": ["High-Performance Computing", "Engineering", "Dev(Sec)Ops", "Security"],
  "blog-articles/engineering/knowledge-graphs-and-metaphysics.html": ["Engineering", "Philosophy", "Data Engineering", "Generative AI", "Machine Learning"],
  "blog-articles/ai/agi/general-over-what.html": ["AGI", "Machine Learning", "Philosophy", "AI Strategy"],
  ...
  "blog-articles/ai/agi/what-would-tell-them-apart.html": ["AGI", "Machine Learning", "AI Strategy", "Philosophy"],
  "blog-articles/ai/ai-security/ai-security-frameworks.html": ["AI Security", "Security", "Machine Learning", "AI Strategy", "Software Security"],
  ...
  "blog-articles/security/critical-infrastructure/commercial-facilities-cybersecurity.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  "blog-articles/philosophy/the-self-in-question.html": ["Philosophy"],
  "blog-articles/security/critical-infrastructure/dams-cyber-security.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  "blog-articles/security/critical-infrastructure/food-agriculture-cybersecurity.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  ...
  "blog-articles/security/critical-infrastructure/nuclear-cyber-security.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  ...
  "blog-articles/security/critical-infrastructure/transportation-cyber-security.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  "blog-articles/security/critical-infrastructure/water-cyber.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  "blog-articles/security/critical-infrastructure/energy-sector-cybersecurity.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  ...
  "blog-articles/security/pentesting/windows-legacy-security.html": ["ICS/OT", "Security", "Operating Systems", "Pentesting", "Cyber-Physical Systems"],
  ...
  "blog-articles/programming-languages/cpp.html": ["Programming & Software", "Programming Languages", "Operating Systems", "Engineering", "High-Performance Computing"],
  ...
  "blog-articles/hardware/cpu-fundamentals.html": ["Engineering", "Hardware", "Operating Systems", "High-Performance Computing"],
  ...
  "blog-articles/security/pentesting/ot-ics-scada-pentesting.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Pentesting"],
  ...
  "blog-articles/physics/models-of-reality.html": ["Philosophy", "Machine Learning", "Math", "Physics"],
  ...
  "blog-articles/ai/mlops.html": ["Machine Learning", "Engineering", "Programming & Software"],
  ...
  "blog-articles/networks/control_pyramid.html": ["ICS/OT", "Cyber-Physical Systems", "Engineering", "Networks", "Control Theory & Engineering"],
  ...
  "blog-articles/ai/efficient-edge-ai.html": ["Machine Learning", "Cloud", "Cyber-Physical Systems", "Engineering"],
  "blog-articles/ai/vibe-coding-risk-framework.html": ["Machine Learning", "AI Strategy", "Programming & Software", "Security", "Dev(Sec)Ops"],
  ...
  "blog-articles/ai/mcp.html": ["Machine Learning", "AI Agents", "AI Strategy", "Programming & Software", "Security"],
  ...
  "blog-articles/ai/planning-reduction-sat-modelchecking.html": ["Machine Learning", "Programming & Software", "Math"],
  ...
  "blog-articles/cyber-physical-systems/embedded-compute-layer.html": ["ICS/OT", "Cyber-Physical Systems", "Engineering", "IoT"],
  "blog-articles/cyber-physical-systems/cps-physical-layer.html": ["Cyber-Physical Systems", "Engineering"],
  "blog-articles/ai/ai-model-vulnerabilities.html": ["Machine Learning", "Security", "Dev(Sec)Ops"],
  ...
  "blog-articles/ai/action-model-learning.html": ["Machine Learning", "Programming & Software"],
  "blog-articles/ai/explainable-ai-lime-shap.html": ["Machine Learning"],
  "blog-articles/veganism/insects-and-small-animals.html": ["Veganism", "Philosophy"],
  "blog-articles/ai/automated-planning.html": ["Machine Learning", "Programming & Software"],
  ...
  "blog-articles/ai/grc-enterprise-ai-data-governance.html": ["Machine Learning", "AI Strategy", "Security", "Society & Civics"],
  ...
  "blog-articles/security/critical-infrastructure/smart-grid-challenges.html": ["ICS/OT", "Cyber-Physical Systems", "Engineering", "Security", "Control Theory & Engineering"],
  "blog-articles/veganism/vegan-activism-incentives.html": ["Veganism", "Society & Civics"],
  "blog-articles/security/critical-infrastructure/industrial-protocol-design.html": ["ICS/OT", "Cyber-Physical Systems", "Networks", "Security"],
  ...
  "blog-articles/ai/fraud-and-ai.html": ["Machine Learning", "Security", "Society & Civics"],
  "blog-articles/philosophy/outages-are-inevitable.html": ["Engineering", "Philosophy"],
  "blog-articles/philosophy/limits-of-knowledge.html": ["Philosophy", "Machine Learning"],
  ...
  "blog-articles/spring/spring-cloud.html": ["Java", "Cloud", "Programming & Software", "Spring", "Dev(Sec)Ops", "Networks"],
  "blog-articles/spring/spring-core-annotations.html": ["Java", "Programming & Software", "Spring"],
  "blog-articles/spring/spring-data-jpa.html": ["Java", "Programming & Software", "Spring", "Data Engineering"],
  "blog-articles/spring/spring-data-modules.html": ["Java", "Programming & Software", "Spring", "Data Engineering"],
  "blog-articles/spring/spring-deployment.html": ["Java", "Cloud", "Programming & Software", "Spring", "Dev(Sec)Ops", "Docker", "Kubernetes"],
  "blog-articles/spring/spring-environment-and-profiles.html": ["Java", "Programming & Software", "Spring", "Dev(Sec)Ops"],
  "blog-articles/spring/spring-file-uploads.html": ["Java", "Programming & Software", "Spring", "Security"],
  "blog-articles/spring/spring-integration-patterns.html": ["Java", "Programming & Software", "Spring", "Networks", "Software Design & Architecture"],
  "blog-articles/spring/spring-internationalization.html": ["Java", "Programming & Software", "Spring", "Web & UI"],
  "blog-articles/spring/spring-jdbc.html": ["Java", "Programming & Software", "Spring", "Data Engineering"],
  "blog-articles/spring/spring-messaging.html": ["Java", "Programming & Software", "Spring", "Networks"],
  "blog-articles/spring/spring-microservices.html": ["Java", "Cloud", "Programming & Software", "Spring", "Networks", "Software Design & Architecture"],
  "blog-articles/spring/spring-mvc.html": ["Java", "Programming & Software", "Spring", "Web & UI", "Software Design & Architecture"],
  "blog-articles/spring/spring-native-graalvm.html": ["Java", "Programming & Software", "Spring", "Dev(Sec)Ops"],
  "blog-articles/spring/spring-observability.html": ["Java", "Programming & Software", "Spring", "Dev(Sec)Ops"],
  "blog-articles/spring/spring-orm-integration.html": ["Java", "Programming & Software", "Spring", "Data Engineering"],
  "blog-articles/spring/spring-performance-optimization.html": ["Java", "Programming & Software", "Spring", "Dev(Sec)Ops"],
  "blog-articles/spring/spring-resource-management.html": ["Java", "Programming & Software", "Spring", "Security"],
  ...
  "blog-articles/ai/ai-security/ai-threat-landscape.html": ["AI Security", "Security", "Machine Learning"],
  ...
  "blog-articles/java/java-build-dependency-management.html": ["Java", "Programming & Software", "Dev(Sec)Ops"],
  "blog-articles/java/java-build-quality.html": ["Java", "Programming & Software", "Dev(Sec)Ops", "SDLC"],
  ...
  "blog-articles/java/java-logging.html": ["Java", "Programming & Software", "Dev(Sec)Ops"],
  "blog-articles/java/java-monitoring-observability.html": ["Java", "Programming & Software", "Dev(Sec)Ops"],
  "blog-articles/java/java-networking.html": ["Java", "Programming & Software", "Networks"],
  "blog-articles/java/java-performance.html": ["Java", "Programming & Software", "Dev(Sec)Ops"],
  ...
  "blog-articles/networks/phasor-measurement-units.html": ["ICS/OT", "Cyber-Physical Systems", "Engineering", "Networks", "Control Theory & Engineering"],
  ...
  "blog-articles/security/critical-infrastructure/critical-manufacturing-cybersecurity.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Networks", "Engineering"],
  ...
  "blog-articles/security/critical-infrastructure/chemical-sector-cybersecurity.html": ["ICS/OT", "Security", "Cyber-Physical Systems", "Engineering"],
  ...
  "blog-articles/ai/the-integration-imperative.html": ["Machine Learning", "Generative AI", "AI Agents", "AI Strategy", "Programming & Software", "Dev(Sec)Ops"],
  ...
  "blog-articles/security/pentesting/hardware-embedded-pentesting.html": ["ICS/OT", "Security", "Engineering", "Cyber-Physical Systems", "Pentesting"],
  "blog-articles/ai/agno-framework.html": ["Machine Learning", "Generative AI", "AI Agents", "AI Strategy", "Programming & Software"],
  "blog-articles/math/Cantors-Paradise.html": ["Math", "Philosophy"],
  "blog-articles/ai/chainlit.html": ["Machine Learning", "Generative AI", "AI Agents", "Programming & Software", "Python"],
  "blog-articles/cyber-physical-systems/control-engineering-implementation.html": ["ICS/OT", "Cyber-Physical Systems", "Engineering", "Control Theory & Engineering"],
  ...
  "blog-articles/ai/enterprise-ai-agent-roadmap.html": ["Machine Learning", "Generative AI", "AI Agents", "AI Strategy", "Programming & Software", "Dev(Sec)Ops"],
