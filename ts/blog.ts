...
const blogPostCategoriesByPath: Record<string, BlogCategory[]> = {
  ...
  "blog-articles/ai-model-vulnerabilities.html": ["AI & ML", "Security", "DevSecOps"],
  ...
  "blog-articles/enterprise-ai-agent-roadmap.html": ["AI & ML", "AI Agents", "AI Strategy", "Programming & Software", "DevSecOps"],
